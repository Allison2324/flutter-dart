              ...
              onPressed: () async {
                var res = await Navigator.push(context, MaterialPageRoute<void>(
                  builder: (BuildContext context) {
                    return Scaffold(
                      appBar: AppBar(
                        title: const Text('Page to return data'),
                      ),
                      body: Center(
                          child: Column(
              ...
              onPressed: () {
                Navigator.push(
                    ...
                    MaterialPageRoute<void>(
                        builder: (context) =>
                            const Insights(userName: 'Allison')));
              },
...
class AnimatedBarChart extends AnimatedWidget {
  ...
  static final _colorTween = ColorTween(begin: Colors.amber, end: randomColor);
...
class _InsightsState extends State<Insights>
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: SingleChildScrollView(
        child: Column(
          children: [AnimatedBarChart(animation: animation)],
        ),
      ),
    );
  }
...
Future<List<Map<String, dynamic>>> fetchFromServer() async {
  final response = await http.get(Uri.parse(
      "https://raw.githubusercontent.com/Allison2324/flutter-dart/main/lab3/test.json"));
...
Future<String> getStringWithDelay() async {
...
Future<void> asyncDemonstration() async {
  print(await fetchFromServer());
  print('await...');
  print(await getStringWithDelay());
  print('.then()...');
  getStringWithDelay().then((response) {
    print(response);
  });
}
